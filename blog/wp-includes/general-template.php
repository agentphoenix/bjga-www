...
function get_search_form($echo = true) {
	...
	$form = '<form role="search" method="get" id="searchform" class="form-search" action="' . esc_url( home_url( '/' ) ) . '" >
	<div class="controls"><div class="input-append">
	<input type="text" value="' . get_search_query() . '" name="s" id="s" class="span8 search-query" placeholder="Search">
	<button type="submit" id="searchsubmit" class="btn">'.esc_attr__('Search').'</button>
	</div></div>
	</form>';
