...
@section('content')
	...
	<p>The Brian Jacobs Golf wants to offer your child the opportunity to learn the game of golf the right way and build on that foundation with each session. To do that, we teach golf skills, etiquette and rules while playing on the Mill Creek Short Course each week*.</p>
