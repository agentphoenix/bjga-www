...
@section('content')
	...
	<p>The Brian Jacobs Golf Junior Team, as with any program we offer, is founded with an emphasis on education, honorable behavior, making an impact in a positive way and personal growth, both on and off the golf course.</p>
