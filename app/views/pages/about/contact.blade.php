...
@section('content')
	...
	<div class="btn-group visible-desktop">
		<a href="{{ URL::to_route('contact') }}" class="btn btn-primary">General Questions</a>
		<a href="{{ URL::to_route('contact', array('schools')) }}" class="btn btn-primary">Golf Schools</a>
		<a href="{{ URL::to_route('contact', array('clinics')) }}" class="btn btn-primary">Golf Clinics</a>
	</div>
