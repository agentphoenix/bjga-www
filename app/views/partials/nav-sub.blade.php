<nav class="nav-sub hidden-phone">
	...
	@if (URI::is('about/*') or URI::is('/'))
		<ul>
			...
			<li class="{{ URI::is('about/news') ? 'active' : '' }}"><a href="{{ URL::to_route('news') }}">News</a><div class="arrow"></div></li>
...
<div class="visible-phone">
	@if (URI::is('about/*') or URI::is('/'))
		<ul class="nav nav-list">
			...
			<li class="{{ URI::is('about/news') ? 'active' : '' }}"><a href="{{ URL::to_route('news') }}">News</a></li>
